  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="relative bg-gradient-to-br from-indigo-600 via-purple-600 to-pink-500 overflow-hidden">
        <div className="relative max-w-screen-desktop mx-auto px-4 py-16 tablet:py-24 text-center">
          {/* Title Skeleton */}
          <div className="flex justify-center mb-4">
            <div className="h-12 tablet:h-16 desktop:h-20 bg-white/20 rounded w-3/4 animate-pulse"></div>
          </div>

          {/* Subtitle Skeleton */}
          <div className="flex justify-center mb-8">
            <div className="h-6 tablet:h-8 bg-white/20 rounded w-1/2 animate-pulse"></div>
          </div>
          ...
          <div className="flex flex-col mobile:flex-row gap-4 justify-center">
            <div className="h-14 bg-white/90 rounded-xl w-48 mx-auto mobile:mx-0 animate-pulse"></div>
            <div className="h-14 bg-white/20 rounded-xl w-48 mx-auto mobile:mx-0 animate-pulse"></div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-gray-900 py-8">
        <div className="max-w-screen-desktop mx-auto px-4 text-center">
