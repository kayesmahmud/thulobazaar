              ...
              <div className="px-6 pb-6">
                ...
                <div className="relative -mt-12 mb-4 flex justify-center">
                  <UserAvatar
                    ...
                    size="xl"
                    borderColor={
                      profile.businessVerificationStatus === 'approved' || profile.businessVerificationStatus === 'verified'
                        ? 'gold'
                  ...
                  {(profile.individualVerified || profile.businessVerificationStatus === 'approved' || profile.businessVerificationStatus === 'verified') && (
                    <div className="absolute bottom-0 right-1/2 translate-x-10 translate-y-1 w-7 h-7 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-full flex items-center justify-center shadow-lg border-2 border-white">
