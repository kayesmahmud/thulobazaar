-- Add 32 Wards of Kathmandu Metropolitan City with their areas
...
INSERT INTO locations (name, slug, type, parent_id) VALUES ('Thamel Marg', 'thamel-marg', 'area', (SELECT id FROM locations WHERE slug = 'ward-2' AND parent_id = 30101));
INSERT INTO locations (name, slug, type, parent_id) VALUES ('Hotel Area', 'hotel-area', 'area', (SELECT id FROM locations WHERE slug = 'ward-2' AND parent_id = 30101));
...
INSERT INTO locations (name, slug, type, parent_id) VALUES ('Bouddha', 'bouddha', 'area', (SELECT id FROM locations WHERE slug = 'ward-4' AND parent_id = 30101));
INSERT INTO locations (name, slug, type, parent_id) VALUES ('Bouddha Stupa area', 'bouddha-stupa-area', 'area', (SELECT id FROM locations WHERE slug = 'ward-4' AND parent_id = 30101));
INSERT INTO locations (name, slug, type, parent_id) VALUES ('Boudhanath Dhumberahi', 'boudhanath-dhumberahi', 'area', (SELECT id FROM locations WHERE slug = 'ward-4' AND parent_id = 30101));
...
INSERT INTO locations (name, slug, type, parent_id) VALUES ('Laganlkol', 'laganlkol', 'area', (SELECT id FROM locations WHERE slug = 'ward-9' AND parent_id = 30101));
...
INSERT INTO locations (name, slug, type, parent_id) VALUES ('Gagal Pul', 'gagal-pul', 'area', (SELECT id FROM locations WHERE slug = 'ward-20' AND parent_id = 30101));
...
INSERT INTO locations (name, slug, type, parent_id) VALUES ('Durbarmare', 'durbarmare', 'area', (SELECT id FROM locations WHERE slug = 'ward-25' AND parent_id = 30101));
