...
/**
 * Vehicles Template Form
 * Handles Cars, Motorbikes, Bicycles, Auto Parts, etc.
 */
function VehiclesForm({ fields, values, onChange, errors, subcategoryName }) {
  ...
  return (
    <div className="template-form vehicles-form">
      <div className="template-form-header">
        <h3>🚗 Vehicle Details</h3>
        <p className="template-form-subtitle">
          Provide specific details about your {subcategoryName || 'vehicle'}
        </p>
      </div>
