...
/**
 * Services & Jobs Template Form
 * Handles Services, Jobs, Tuition, and Overseas Employment
 */
function ServicesForm({ fields, values, onChange, errors, subcategoryName }) {
  ...
  return (
    <div className="template-form services-form">
      <div className="template-form-header">
        <h3>💼 Service/Job Details</h3>
        <p className="template-form-subtitle">
          Provide specific details about your {subcategoryName || 'service/job'}
        </p>
      </div>
