...
/**
 * Electronics & Gadgets Template Form
 * Handles Mobiles, Laptops, TVs, Cameras, etc.
 */
function ElectronicsForm({ fields, values, onChange, errors, subcategoryName }) {
  ...
  return (
    <div className="template-form electronics-form">
      <div className="template-form-header">
        <h3>📱 Electronics & Gadgets Details</h3>
        <p className="template-form-subtitle">
          Provide specific details about your {subcategoryName || 'electronics item'}
        </p>
      </div>
