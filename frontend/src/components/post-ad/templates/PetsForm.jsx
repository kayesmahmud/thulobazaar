...
/**
 * Pets & Animals Template Form
 * Handles Pets, Farm Animals, Pet Accessories, and Pet Food
 */
function PetsForm({ fields, values, onChange, errors, subcategoryName }) {
  ...
  return (
    <div className="template-form pets-form">
      <div className="template-form-header">
        <h3>🐾 Pet & Animal Details</h3>
        <p className="template-form-subtitle">
          Provide specific details about your {subcategoryName || 'pet/animal'}
        </p>
      </div>
