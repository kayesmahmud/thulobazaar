...
/**
 * Property Template Form
 * Handles Land, Apartments, Houses, Commercial Property, etc.
 */
function PropertyForm({ fields, values, onChange, errors, subcategoryName }) {
  ...
  return (
    <div className="template-form property-form">
      <div className="template-form-header">
        <h3>🏠 Property Details</h3>
        <p className="template-form-subtitle">
          Provide specific details about your {subcategoryName || 'property'}
        </p>
      </div>
